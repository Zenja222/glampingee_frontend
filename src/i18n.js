...
const resources = {
    ...
    et: {
        translation: {
            ...
            "est_glampings": "Eesti Glampingud",
            "select_sort_field": "Vali sorteerimise väli",
            "ascending": "Tõusvas järjekorras",
            "descending": "Dulenevas järjekorras",
            "loading_glampings": "Laadimine glampings...",
            "no_description": "Kirjeldus puudub.",
            "error_fetching": "Andmete allalaadimise viga.",
            "failed_to_load": "Glampingute andmete laadimine ebaõnnestus.",
            "loading": "Laadimine...",
            "glamping_not_found": "Glampingut ei leitud.",
            "previous": "Eelmine",
            "next": "Järgmine",
            "county": "Maakond",
