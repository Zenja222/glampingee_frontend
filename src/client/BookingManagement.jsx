...
export const addGlamping = async (glamping) => {
    try {
        const response =
            await axios.post('http://localhost:8080/glamping', glamping);
        return response.data;
    } catch (error) {
        if (error.response) {
            // Server responded with a status other than 200 range
...
export const searchByName = async (keyword,language) => {
    try {
        const response =
            await axios.get('http://localhost:8080/glamping/search', {params: {keyword, language}});
        return response.data;
    } catch (error) {
        if (error.response) {
            // Server responded with a status other than 200 range
...
export const filterByPriceRange = async (minPrice, maxPrice) => {
    try {
        const response = await axios.get('http://localhost:8080/glamping/filterByPrice', {
